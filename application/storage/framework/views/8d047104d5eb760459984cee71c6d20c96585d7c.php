<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" type="text/css" href="<?php echo e(voyager_asset('css/nestable.css')); ?>">
            ...
            <div class="modal-content">
                ...
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo $__env->make('voyager::multilingual.input-hidden', ['_field_name' => 'title', '_field_trans' => ''], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(voyager_asset('js/jquery.nestable.js')); ?>"></script>
