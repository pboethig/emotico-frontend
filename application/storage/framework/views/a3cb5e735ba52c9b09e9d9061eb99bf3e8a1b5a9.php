...
<?php echo $__env->make('voyager::tools.database.vue-components.database-types', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('voyager::tools.database.vue-components.database-column-default', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
