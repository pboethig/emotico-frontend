...
<?php $__env->startSection('page_header'); ?>
    <h1 class="page-title">
        ...
        <?php if(Voyager::can('download_'.$dataType->name)): ?>
        <a href="<?php echo e(\App\Helper\Asset\Url::getDownloadUrlByDataType($dataTypeContent)); ?>" class="btn btn-info">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    <?php $__currentLoopData = $dataType->readRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            <?php elseif($row->type == 'emotico-thumbnaillist'): ?>
                                <?php echo $__env->make('voyager::multilingual.input-hidden-bread-read', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php echo $__env->make('bread.assets.editthumbnaillist', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php else: ?>
                                <?php echo $__env->make('voyager::multilingual.input-hidden-bread-read', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
