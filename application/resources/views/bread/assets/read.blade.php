...
@section('page_header')
    <h1 class="page-title">
        ...
        @if (Voyager::can('download_'.$dataType->name))
        <a href="{{ \App\Helper\Asset\Url::getDownloadUrlByDataType($dataTypeContent) }}" class="btn btn-info">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    @foreach($dataType->readRows as $row)
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            @elseif($row->type == 'emotico-thumbnaillist')
                                @include('voyager::multilingual.input-hidden-bread-read')
                                @include('bread.assets.editthumbnaillist')
                            @else
                                @include('voyager::multilingual.input-hidden-bread-read')
